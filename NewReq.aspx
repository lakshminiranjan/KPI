    ...
    <dx:ASPxCallbackPanel ID="cpMain" runat="server" ClientInstanceName="cpMain" OnCallback="cpMain_Callback">
        <PanelCollection>
            <dx:PanelContent>
                ...
                <div class="toolbar">
                    <dx:ASPxLabel ID="lblSection" runat="server" Text="KPI Section:" AssociatedControlID="ddlSection" />
                    <dx:ASPxComboBox ID="ddlSection" runat="server" Width="300px" IncrementalFilteringMode="Contains"
                        DropDownStyle="DropDownList" ClientInstanceName="ddlSection" />
                ...
                <div class="section">
                    <dxpg:ASPxPivotGrid ID="pvKPI" runat="server" ClientInstanceName="pvKPI"
                        ...
                        <Fields>
                            <dxpg:PivotGridField ID="fieldKPISection" FieldName="KPI_Section" Area="RowArea" Caption="KPI Section" />
                            <dxpg:PivotGridField ID="fieldKPIName" FieldName="KPI Name" Area="RowArea" Caption="KPI Name" />
                            <dxpg:PivotGridField ID="fieldActive" FieldName="Active" Area="ColumnArea" Caption="Active" />
